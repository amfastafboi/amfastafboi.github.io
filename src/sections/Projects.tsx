...
export const ProjectsSection = () => {
  return <section className="pb-16 lg:py-24">
    <div className="container" id="projects">
      ...
      <p className="text-center lg:text-xl md:text-lg text-white/60 mt-4 max-w-md mx-auto">See how I transformed concepts into engaging Digital experiences.</p>
      <div className="flex flex-col mt-10 gap-20 md:mt-20 ">
        {portfolioProjects.map((project, projectIndex) => (
            <div key={project.title} className="bg-gray-800 rounded-3xl z-0 overflow-hidden after:z-10 after:content-[''] after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 after:pointer-events-none md:pt-12 md:px-10 lg:pt-16 lg:px-20 sticky" style={{
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-16">
              <div className="lg:pb-16">
                ...
                <a href="{project.link}">
                  <button className="bg-white text-gray-950 h-12 md:w-auto md:px-7 w-full rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8"><span>View Live Site</span>
