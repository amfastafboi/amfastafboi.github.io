...
export const ContactSection = () => {
  return <div className='py-16 pt-12 lg:py-24 lg:pt-20 relative z-10'>
        ...
        <div className='flex flex-col md:flex-row gap-8 md:gap-16 items-center'>
          ...
          <div>
            <button className='text-white bg-gray-900 inline-flex items-center px-6 h-12 rounded-xl gap-2 mt-8 w-max border border-gray-900'>
              <a className='inline-flex items-center' href="https://www.instagram.com/amfastafboi" target="_blank">
